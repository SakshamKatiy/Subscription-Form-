...
<head>
    ...
    <title>Subscription Form | Saksham Katiyar</title>
...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="content">
      ...
      <p>Subscribe to our Hanuman Ke Pakawan website and get the latest updates straight to your inbox.</p>
    </div>
    ...
    if(isset($_POST['subscribe'])){
      ...
      if(filter_var($userEmail, FILTER_VALIDATE_EMAIL)){ 
        $subject = "Thanks for Visiting Hanuman ke Pakawan";
        ...
        $sender = "From: yadav.ahul510gmail.com";
